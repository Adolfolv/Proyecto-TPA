"""Pantalla de menú principal visual sin navegación real.."""
...
class VistaMenu(tk.Frame):
    ...
    def crear_widgets(self):
        ...
        self.moldes.crear_tarjeta_acceso_menu(derecha, "Historial", "Consulta viajes, transacciones y actividad anterior.", comando=lambda: self.navegar("historial"), metodo="grid", fila=0, columna=0, sticky="nsew", margen_y=(0, 8))
        self.moldes.crear_tarjeta_acceso_menu(derecha, "Tarjeta social", "Accede a beneficios, perfil público y comunidad.", comando = lambda: self.navegar("reputacion"), metodo="grid", fila=1, columna=0, sticky="nsew", margen_y=(8, 0))
