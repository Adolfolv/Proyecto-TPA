...
class VistaRegistro(tk.Frame):
    def __init__(self):
        ventana = tk.Tk()
        ventana.title(TITULO_REGISTRO)
        ventana.geometry(GEOMETRIA_REGISTRO)
        ventana.minsize(*TAMANO_MINIMO_REGISTRO)
        ventana.attributes("-fullscreen", PANTALLA_COMPLETA_REGISTRO)
    ...
    def crear_widgets(self):
        ...
        self.moldes.crear_boton(contenedor, "Registrarse", True, 16, None, margen_x=5, margen_y=(14, 0))
    ...
    def crear_formulario_pasajero(self):
        ...
        self.moldes.crear_entrada(bloque).grid(row=5, column=1, sticky="ew", padx=5, pady=(5, 6), ipady=7)
    ...
    def crear_formulario_conductor(self):
        ...
        self.moldes.crear_entrada(bloque_personal).grid(row=5, column=1, sticky="ew", padx=5, pady=(5, 6), ipady=7)
        ...
        self.moldes.crear_label(bloque_derecho, "Numero de licencia", tema.FUENTE_BOTON, tema.TEXTO, tema.PANEL_SUAVE).grid(row=10, column=1, sticky="w", padx=5, pady=(6, 0))
        ...
        self.moldes.crear_label(bloque_derecho, "Vencimiento de licencia", tema.FUENTE_BOTON, tema.TEXTO, tema.PANEL_SUAVE).grid(row=12, column=0, sticky="w", padx=5, pady=(6, 0))
        self.moldes.crear_label(bloque_derecho, "RUT", tema.FUENTE_BOTON, tema.TEXTO, tema.PANEL_SUAVE).grid(row=12, column=1, sticky="w", padx=5, pady=(6, 0))
